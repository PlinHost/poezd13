...
/obj/machinery/door_control/vent_control
	...
	var/announced_message = "CORE VENTS CYCLING"
	var/announced_message_author = "Core control computer"
...
/obj/machinery/door_control/vent_control/attack_hand(mob/user as mob)
	...
	if(announced_message && announced_message_author)
		var/obj/item/device/radio/a = new /obj/item/device/radio(null)
		a.autosay(announced_message, announced_message_author)
