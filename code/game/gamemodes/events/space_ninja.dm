...
message = text2list2text(message, "l", "r")
message = text2list2text(message, "rr", "ru")
message = text2list2text(message, "v", "b")
message = text2list2text(message, "f", "hu")
message = text2list2text(message, "'t", "")
message = text2list2text(message, "t ", "to ")
message = text2list2text(message, " I ", " ai ")
message = text2list2text(message, "th", "z")
message = text2list2text(message, "ish", "isu")
message = text2list2text(message, "is", "izu")
message = text2list2text(message, "ziz", "zis")
message = text2list2text(message, "se", "su")
message = text2list2text(message, "br", "bur")
message = text2list2text(message, "ry", "ri")
message = text2list2text(message, "you", "yuu")
message = text2list2text(message, "ck", "cku")
message = text2list2text(message, "eu", "uu")
message = text2list2text(message, "ow", "au")
message = text2list2text(message, "are", "aa")
message = text2list2text(message, "ay", "ayu")
message = text2list2text(message, "ea", "ii")
message = text2list2text(message, "ch", "chi")
message = text2list2text(message, "than", "sen")
message = text2list2text(message, ".", "")
