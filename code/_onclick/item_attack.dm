...
/obj/item/proc/attack(mob/living/M as mob, mob/living/user as mob, def_zone)
	...
	if(!istype(M, /mob/living/carbon/human))
		if(istype(M, /mob/living/carbon/slime))
			slime_attack(M, user, def_zone, power)
	...
	if(istype(M, /mob/living/carbon/human))
		combat_system_attack(M, user, def_zone)
...
/obj/item/proc/combat_system_attack(mob/living/M as mob, mob/living/user as mob, def_zone)




/obj/item/proc/slime_attack(mob/living/M as mob, mob/living/user as mob, def_zone, var/power)
	if(istype(M, /mob/living/carbon/slime))
